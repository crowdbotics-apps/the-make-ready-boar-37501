...
## Project Structure
    ...
    ├── the_make_ready_boar_37501  # Django project configurations
...
1. Clone this repo and `cd the_make_ready_boar_37501`
...
2. Clone this repo and `cd the_make_ready_boar_37501`
